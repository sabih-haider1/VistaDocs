            ...
            {service.content.sections.map((section, index) => (
              ...
              >
                <div className={`rounded-2xl p-6 sm:p-8 border-2 shadow-lg ${
                  ...
                  <div
                    className="prose prose-lg max-w-none prose-h3:text-primary-700 prose-li:before:text-primary-500 prose-a:text-primary-600 hover:prose-a:text-primary-700 [&_ul]:list-none [&_ul]:pl-6 [&_ul_li]:before:content-['✓'] [&_ul_li]:before:mr-2 [&_ul_li]:before:font-bold"
